...
def render_content(tab):
    if tab == 'tab_individual':
        return [html.Div([
                ...
                #Charts or Graphs
                html.Div([
                    html.H1(children='probando', id='title_individual_graph1', className='title_graph'),
                ...
                html.Div([
                    html.Div([      
                        html.H1(children='', id='title_individual_graph2', className='title_graph'),                  
                    ...
                    html.Div([
                        html.H1(children='', id='title_individual_graph3', className='title_graph'),
                ...
                html.Div([
                    html.H1(children='', id='title_individual_graph4', className='title_graph'),
        ...
        return [html.Div([
                ...
                html.Div([
                    html.H1(children='', id='title_general_graph1', className='title_graph'),
                ...
                html.Div([
                    html.H1(children='', id='title_general_graph2', className='title_graph'),
                ...
                html.Div([
                    html.Div([
                        html.H1(children='', id='title_general_graph3', className='title_graph'),                      
                    ...
                    html.Div([
                        html.H1(children='', id='title_general_graph4', className='title_graph'),
                ...
                html.Div([
                    html.Div([                        
                        html.H1(children='', id='title_general_graph5', className='title_graph'),
                    ...
                    html.Div([
                        html.H1(children='', id='title_general_graph6', className='title_graph'),
                ...
                html.Div([
                    html.H1(children='', id='title_general_graph7', className='title_graph'),
                ...
                html.Div([
                    html.Div([
                        html.H1(children='', id='title_general_graph8', className='title_graph'),        
                    ...
                    html.Div([
                        html.H1(children='', id='title_general_graph9', className='title_graph'),
