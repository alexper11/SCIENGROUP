...
class ExtractorGruplac(ExtractorCvlac):
    ...
    def __init__(self):
        ...
        self.grup_libros=pd.DataFrame(columns=['idcvlac','autores','nombre','tipo','lugar','fecha','editorial','isbn','volumen','paginas','palabras','areas','sectores'])
        ...
        self.grup_software=pd.DataFrame(columns=['idcvlac','autor','nombre','tipo','nombre_comercial','contrato_registro','lugar','fecha','plataforma','ambiente','palabras','areas','sectores'])
