...
if __name__ == '__main__':
    ...
    try:
        shutil.rmtree('dashboard/assets/data/extracted_data')
        os.mkdir('dashboard/assets/data/extracted_data')
    ...
    aux_basico.to_csv('dashboard/assets/data/extracted_data/aux_basico.csv',index=False)
    ...
    aux_articulos.to_csv('dashboard/assets/data/extracted_data/aux_articulos.csv',index=False)
    ...
    aux_actuacion.to_csv('dashboard/assets/data/extracted_data/aux_actuacion.csv',index=False)
    ...
    aux_identificadores.to_csv('dashboard/assets/data/extracted_data/aux_identificadores.csv',index=False)
    ...
    aux_investigacion.to_csv('dashboard/assets/data/extracted_data/aux_investigacion.csv',index=False)
    ...
    aux_libros.to_csv('dashboard/assets/data/extracted_data/aux_libros.csv',index=False)
    ...
    aux_reconocimiento.to_csv('dashboard/assets/data/extracted_data/aux_reconocimiento.csv',index=False)
    ...
    aux_redes.to_csv('dashboard/assets/data/extracted_data/aux_redes.csv',index=False)
    ...
    aux_caplibros.to_csv('dashboard/assets/data/extracted_data/aux_caplibros.csv',index=False)
    ...
    aux_empresatec.to_csv('dashboard/assets/data/extracted_data/aux_empresatec.csv',index=False)
    ...
    aux_innovaempresa.to_csv('dashboard/assets/data/extracted_data/aux_innovaempresa.csv',index=False)
    ...
    aux_prototipo.to_csv('dashboard/assets/data/extracted_data/aux_prototipo.csv',index=False)
    ...
    aux_software.to_csv('dashboard/assets/data/extracted_data/aux_software.csv',index=False)
    ...
    aux_tecnologicos.to_csv('dashboard/assets/data/extracted_data/aux_tecnologicos.csv',index=False)
    ...
    aux_basicog.to_csv('dashboard/assets/data/extracted_data/aux_basicog.csv',index=False)
    basicog.insert_df(aux_basicog)
    del basicog
    
    articulosg=ArticulosGController()
    aux_articulosg=Extractor.perfil_articulos
    aux_articulosg.to_csv('dashboard/assets/data/extracted_data/aux_articulosg.csv',index=False)
    articulosg.insert_df(aux_articulosg)
    del articulosg
    
    instituciones=InstitucionesController()
    aux_instituciones=Extractor.perfil_instituciones
    aux_instituciones.to_csv('dashboard/assets/data/extracted_data/aux_instituciones.csv',index=False)
    instituciones.insert_df(aux_instituciones)
    del instituciones
    
    lineasg=LineasGController()
    aux_lineas=Extractor.perfil_lineas
    aux_lineas.to_csv('dashboard/assets/data/extracted_data/aux_lineas.csv',index=False)
    lineasg.insert_df(Extractor.perfil_lineas)
    del lineasg
    
    integrantes=IntegrantesController()
    aux_integrantes=Extractor.perfil_integrantes
    aux_integrantes.to_csv('dashboard/assets/data/extracted_data/aux_integrantes.csv',index=False)
    ...
    aux_pdoctorado.to_csv('dashboard/assets/data/extracted_data/aux_pdoctorado.csv',index=False)
    pdoctorado.insert_df(aux_pdoctorado)
    del pdoctorado
    
    pmaestria=ProgramaMaestriaController()
    aux_pmaestria=Extractor.perfil_programa_maestria
    aux_pmaestria.to_csv('dashboard/assets/data/extracted_data/aux_pmaestria.csv',index=False)
    ...
    aux_otecnologicos.to_csv('dashboard/assets/data/extracted_data/aux_otecnologicos.csv',index=False)
    otecnologicos.insert_df(aux_otecnologicos)
    del otecnologicos
    
    prototiposg=PrototiposGController()
    aux_prototiposg=Extractor.perfil_prototipos
    aux_prototiposg.to_csv('dashboard/assets/data/extracted_data/aux_prototiposg.csv',index=False)
    prototiposg.insert_df(aux_prototiposg)
    del prototiposg
    
    softwareg=SoftwareGController()
    aux_softwareg=Extractor.perfil_software
    aux_softwareg.to_csv('dashboard/assets/data/extracted_data/aux_softwareg.csv',index=False)
    ...
    aux_empresatecg.to_csv('dashboard/assets/data/extracted_data/aux_empresatecg.csv',index=False)
    ...
    aux_innovaempresag.to_csv('dashboard/assets/data/extracted_data/aux_innovaempresag.csv',index=False)
    ...
    aux_plantapilotog.to_csv('dashboard/assets/data/extracted_data/aux_plantapilotog.csv',index=False)
    ...
    aux_articulosg = pd.read_csv('dashboard/assets/data/extracted_data/aux_articulosg.csv', dtype = str)
    aux_basicog = pd.read_csv('dashboard/assets/data/extracted_data/aux_basicog.csv', dtype = str)
    aux_caplibrosg = pd.read_csv('dashboard/assets/data/extracted_data/aux_caplibrosg.csv', dtype = str)
    aux_identificadores = pd.read_csv('dashboard/assets/data/extracted_data/aux_identificadores.csv', dtype = str)
    aux_integrantes = pd.read_csv('dashboard/assets/data/extracted_data/aux_integrantes.csv', dtype = str)
    aux_librosg = pd.read_csv('dashboard/assets/data/extracted_data/aux_librosg.csv', dtype = str) #pendiente de remplazo
    aux_oarticulos = pd.read_csv('dashboard/assets/data/extracted_data/aux_oarticulos.csv', dtype = str)
    aux_olibros = pd.read_csv('dashboard/assets/data/extracted_data/aux_olibros.csv', dtype = str)
    df_autores = pd.read_csv('dashboard/assets/data/extracted_data/aux_autores.csv', dtype = str).drop(['idgruplac','nombre_grupo','idcvlac'], axis=1)
    df_productos = pd.read_csv('dashboard/assets/data/extracted_data/aux_productos.csv', dtype = str).drop(['idgruplac','nombre_grupo'], axis=1)
