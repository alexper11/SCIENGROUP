...
class Productos(Base):
    ...
    tema = Column(String(5000), nullable=True)
    ...
    autores = Column(String(15000), nullable=True)
    autores_id = Column(String(10000), nullable=True)
    ...
    institucion = Column(String(8000), nullable=True)
