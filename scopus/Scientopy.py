...
class Scientopy(ExtractorScopus):
    def __init__(self, api_key, inst_token):
        ...
        self.input={"Authors":[],"Author(s) ID":[],"Title":[],"Year":[],"Source title":[],"Volume":[],
                    ...
                    "DOI":[],"Link":[],"Document Type":[],"Publication Stage":[],"Access Type":[],"Source":[],"EID":[]}
    ...
    def scopus_input_df(self,topic):
        ...
        for article in articles:
            ...
            self.input['Page count'].append(self.get_page_count(scopus_id,self.input['Page start'][-1]))
            ...
            self.input['Publication Stage'].append(self.get_pub_stage(scopus_id))
